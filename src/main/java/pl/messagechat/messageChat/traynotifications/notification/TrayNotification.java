...
import pl.messagechat.messageChat.traynotifications.animations.*;
import pl.messagechat.messageChat.traynotifications.models.CustomStage;
...
public final class TrayNotification {
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/pl/messagechat/messageChat/chat/TrayNotification.fxml"));
    ...
    public void setNotificationType(NotificationType nType) {
        ...
        switch (nType) {
            ...
            case INFORMATION:
                imageLocation = getClass().getResource("/pl/messagechat/messageChat/traynotifications/resources/info.png");
                paintHex = "#2C54AB";
                break;

            case NOTICE:
                imageLocation = getClass().getResource("/pl/messagechat/messageChat/traynotifications/resources/notice.png");
                paintHex = "#8D9695";
                break;

            case SUCCESS:
                imageLocation = getClass().getResource("/pl/messagechat/messageChat/traynotifications/resources/success.png");
                paintHex = "#009961";
                break;

            case WARNING:
                imageLocation = getClass().getResource("/pl/messagechat/messageChat/traynotifications/resources/warning.png");
                paintHex = "#E23E0A";
                break;

            case ERROR:
                imageLocation = getClass().getResource("/pl/messagechat/messageChat/traynotifications/resources/error.png");
                paintHex = "#CC0033";
                break;
